...
import { ArrowRight, Contact, Download, Github, LucideLinkedin } from "lucide-react";
...
export default function Hero() {
  return (
    <div className={`flex flex-col min-h-screen justify-center text-center ${roboto.className}`}>
      ...
      <div className="flex flex-row justify-center gap-5 mt-7">
        <Link href="/projects">
          <Button className="bg-gradient-to-r from-green-500 to-lime-800 hover:from-green-500 hover:to-lime-900 text-md font-extrabold">Projects
          <ArrowRight />
          </Button>
        </Link>
        <Link href="/contact">
          <Button className="bg-[#404040] hover:bg-[#505050]">Contact
          <Contact />
          </Button>
        </Link>
      </div>
